...
def listen():
    ...
    try:
        ...
        while True:
            ...
            logger.log('RECEIVING PORT:' + str(RELAY_PORT) + ' FORWARDING PORT:' + str(FORWARDING_PORT))
            ...
            logger.log('begin forwarding payload to the next node...')
            ...
            if response is not None:
                ...
                logger.log('send payload to the previous node: ', previous_ip)
...
def deserialize_payload(payload):
    ...
    next_ip, message = crypt.decrypt_payload(DECRYPTED_AES_KEY, encrypted_message)  # decrypted_message = encrypted_payload + next_ip
